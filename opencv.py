...
image = cv.imread('Dataset/Jeruk_Nipis/001.jpg')
cv.imshow('Pepaya', rescale(cv.imread('Dataset/Jeruk_Nipis/001.jpg')))
cv.waitKey(0)
########################################################## open image berupa array
print(cv.imread('Dataset/Jeruk_Nipis/001.jpg'))
...
for img in images :
    ...
    im_name = "Dataset/Jeruk_Nipis_kontras/" + str(i) + ".png"
...
for img in images :
    ...
    im_name1 = "dataset/Jeruk_Nipis_grey/" + str(i) + ".png"
...
for img in images :
    ...
    im_name2 = "Dataset/Jeruk_Nipis_edge/" + str(i) + ".png"
